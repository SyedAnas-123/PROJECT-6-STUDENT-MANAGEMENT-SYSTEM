...
const randomNumber : number = Math.floor(10000 + Math.random() * 90000)//add 10000 bcz we need 5 digits or num change hta rhe toh *90000 7 remove after point values  so user floor
...
const tuotionFess : { [key: string]: number} = {
    "MS OFFICE" : 5000 ,
    "HJTML" : 7000 ,
    "AI" : 10000 ,
